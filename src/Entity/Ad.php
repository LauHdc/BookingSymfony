 ...
 * @UniqueEntity(
 * fields={"title"},
 * message="Une autre annonce contient déjà ce titre, veuillez le modifier"
 * )
 */
class Ad
{
	 ...
	 * @Assert\Length(min=10,max=255,minMessage="Le titre doit comporter + de 10 caractères",maxMessage="Le texte ne doit pas comporter + de 255 caractères")
     */
    private $title;
	 ...
	 * @Assert\Length(min=30,minMessage="Veuillez rentrer au moins 30 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
	 * @Assert\Length(min=100,minMessage="Veuillez rentrer au moins 100 caractères")
     */
    private $content;
